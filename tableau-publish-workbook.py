...
print(f"Connecting to Tableau Server: {SERVER_URL}") # Debug line
print(f"Connecting to Tableau Site: {SITE_ID}") # Debug line
print(f"Connecting to Tableau Project: {PROJECT_NAME}") # Debug line
...
        #list(TSC.Pager(server.projects, request_options))
        #server.projects.get(request_options)
        print("Signed in successfully2")
        all_projects = [{project.name: project.id} for project in all_project_items]
        print("Signed in successfully3")
        print(f"List of Projects: {all_projects}")
        if not PROJECT_NAME:
